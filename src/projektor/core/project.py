...
class Project:
    ...
    def __init__(
        ...
        self._roadmap: Optional["Roadmap"] = None
    ...
    @classmethod
    def init(cls, path: str | Path, name: Optional[str] = None) -> "Project":
        """
    ...
    def list_tickets(
        ...
        if labels:
            result = [t for t in result if any(l in t.labels for l in labels)]
    ...
    @property
    def toon_file(self) -> Optional[Path]:
    ...
    def get_git_remote(self) -> Optional[str]:
