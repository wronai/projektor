...
if TYPE_CHECKING:
    from projektor.core.ticket import Ticket, Priority
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "BacklogItem":
        return cls(
            ...
            added_at=datetime.fromisoformat(data["added_at"]) 
                if "added_at" in data else datetime.now(),
        )
...
class Backlog:
    ...
    def add(self, ticket_id: str, priority: Optional[int] = None) -> BacklogItem:
        """
    ...
    def find(self, ticket_id: str) -> Optional[BacklogItem]:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Backlog":
        ...
        return cls(
            ...
            last_groomed=datetime.fromisoformat(data["last_groomed"]) 
                if data.get("last_groomed") else None,
